<div>
    <div class="w-full max-[500px]:w-full mb-2">
        <div
            class="group w-full h-24 rounded-lg bg-slate-200  transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#000000]">
            <p class="pt-2 text-black text-2xl pl-8">Carrera/Caminata</p>
            <p class="mx-4 text-black text-xl pl-4 group-hover:text-blue-900">{{ $totalMontoPagado }} Bs</p>
            <p class="mx-4 text-black text-md pl-4 group-hover:text-green-800">{{ $this->calculo($totalMontoPagado) }} $
            </p>
    ...
    <div class="bg-white shadow rounded-lg p-4 mb-2 px-2">
        ...
        @if ($GenerarReporte == 'reporteDetallado')
            <x-button class="ml-1 bg-red-700 hover:bg-red-400 focus:bg-red-400 active:bg-red-400" type="button" wire:click='generateDetailedReport'>
                PDF
            </x-button>
            <x-button class="ml-1 bg-green-700 hover:bg-green-400 focus:bg-green-400 active:bg-green-400" type="button" wire:click='generateDetailedReportExcel'>
                Excel
            </x-button>
        @elseif ($GenerarReporte == 'reporteGlobal')
            <x-button class="ml-1 bg-red-700 hover:bg-red-400 focus:bg-red-400 active:bg-red-400" type="button" wire:click='generateReportGlobal'>
                PDF
            </x-button>
            <x-button class="ml-1 bg-green-700 hover:bg-green-400 focus:bg-green-400 active:bg-green-400" type="button" wire:click='generateGlobalReportExcel'>
                Excel
            </x-button>
        @endif
    </div>
            ...
            <tbody>
                @foreach ($reporte as $report)
                    <tr>
                        ...
                        <td class="p-4 border-b border-blue-gray-50">
                            <x-button class="bg-blue-500 hover:bg-slate-300 focus:bg-slate-300 active:bg-slate-300" wire:click="abrir('{{ $report->nomenclatura }}')">
