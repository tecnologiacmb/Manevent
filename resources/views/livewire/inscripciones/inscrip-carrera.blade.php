<div>
    <div class="w-full max-[500px]:w-full mb-2">
        <div
            ...
            <div>
                <img src="{{ asset('storage/image/carrera.png') }}" alt="Imagen de dolar almacenada en storage"
                    class="pt-8 group-hover:opacity-100 absolute right-[8%] top-[30%] translate-y-[-50%] opacity-50 transition group-hover:scale-110 duration-300 w-24">
            </div>
        </div>
    </div>
    <div
